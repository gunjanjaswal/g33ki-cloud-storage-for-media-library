...
class G33ki_Cloud_Storage_For_Media_Library {
    ...
    public function admin_menu() {
        add_menu_page(
            __('⚡ G33ki Cloud Media Offload', 'g33ki-cloud-storage-for-media-library'),
    ...
    public function deactivation_warning_notice() {
        ...
        echo '<p><strong>' . esc_html__('G33ki Cloud Media Offload', 'g33ki-cloud-storage-for-media-library') . ':</strong> ';
